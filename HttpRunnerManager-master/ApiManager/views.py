...
def add_config(request):
    ...
    if request.is_ajax():
        ...
        return render(request,'add_config.html', manage_info)
...
def run_test(request):
    ...
    if request.is_ajax():
        ...
        return render(request,'report_template.html', runner.summary)
...
def test_list(request, id):
    ...
    if request.is_ajax():
        ...
        return render(request,'test_list.html', manage_info)
...
def config_list(request, id):
    ...
    if request.is_ajax():
        ...
        return render(request,'config_list.html', manage_info)
...
def edit_config(request, id=None):
    ...
    return render(request,'edit_config.html', manage_info)
...
def env_set(request):
    ...
    if request.is_ajax():
        ...
        return render(request,'env_list.html', {'account': account})
...
def report_list(request, id):
    ...
    if request.is_ajax():
        ...
        return render(request,'report_list.html', manage_info)
...
def view_report(request, id):
    ...
    return render(request,'view_report.html', {"reports": mark_safe(reports)})
...
def periodictask(request, id):
    ...
    return render(request,'periodictask_list.html', manage_info)
...
def add_task(request):
    ...
    if request.is_ajax():
        ...
        return render(request,'add_task.html', info)
...
def debugtalk(request, id=None):
    if request.method == 'GET':
        ...
        return render(request,'debugtalk.html', debugtalk)
    else:
        id = request.POST.get('id')
...
def debugtalk_list(request, id):
    ...
    return render(request,'debugtalk_list.html', manage_info)
...
def suite_list(request, id):
    ...
    if request.is_ajax():
        ...
        return render(request,'suite_list.html', manage_info)
...
def add_suite(request):
    ...
    if request.is_ajax():
        ...
        return render(request,'add_suite.html', manage_info)
...
def edit_suite(request, id=None):
    ...
    return render(request,'edit_suite.html', manage_info)
